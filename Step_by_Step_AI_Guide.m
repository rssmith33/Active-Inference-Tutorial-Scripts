...
rng('shuffle') % This sets the random number generator to produce a different 
               ...
               % to produce a different random sequence each time)

% Simulation options after model building below:

% If Sim = 1, simulate single trial. This will reproduce fig. 7.
...
rs1 = 3; % Risk-seeking parameter (set to the variable rs below) 
